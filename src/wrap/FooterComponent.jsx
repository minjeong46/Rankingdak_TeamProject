                ...
                <div className="title-container">
                    ...
                    <div className="family-box">
                        <button onClick={onClickSelectBtn} className='select-btn'>
                            <span>패밀리사이트</span>
                            <i className={`material-icons${state.isIcon===true? ' on': ''}`} style={{color: '#666'}}>keyboard_arrow_up</i>
                        </button>
                        {/* 패밀리사이트 */}
                        <ul className={`family-list${state.isList===true? ' on' : ''}`}>
                            <li><a href="https://www.rankingdak.com" target='blank'>랭킹닭컴</a></li>
                            <li><a href="https://www.ggjmart.com" target='blank'>개근질마트</a></li>
                            <li><a href="https://www.ggjil.com" target='blank'>개근질닷컴</a></li>
                            <li><a href="https://pickydiet.co.kr" target='blank'>피키다이어트</a></li>
                            <li><a href="https://dacook.co.kr" target='blank'>다이어트전문 레시피 다쿡</a></li>
                            <li><a href="https://www.studiou.co.kr" target='blank'>바디프로필 전문 스튜디오U</a></li>
                        </ul>
                    </div>
                </div>
            </div>
