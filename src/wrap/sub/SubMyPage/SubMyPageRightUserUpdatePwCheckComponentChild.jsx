...
export default function SubMyPageRightUserUpdatePwCheckComponentChild () {
    ...
    const onSubmitPwCheck=(e)=>{
        ...
        axios({
            url:'https://rankingdark.store/rankingdak_user_pw_search_check_update.php',
            method:'POST',
            data: formData 
        })
        .then((res)=>{
                ...
                <div className="right-content">
                    ...
                    <form action="" onSubmit={onSubmitPwCheck}>
                        <div className="input-box">
                            <input type="password" id='userPw' name='userPw' placeholder='비밀번호 입력' value={state.비밀번호} onChange={onChangePw} />
