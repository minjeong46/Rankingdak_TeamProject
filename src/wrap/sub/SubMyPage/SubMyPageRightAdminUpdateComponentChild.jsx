...
export default function SubMyPageRightAdminUpdateComponentChild ({회원정보}) {
    ...
    const [ state, setState ] = React.useState({
        ...
        휴대폰: 회원정보.휴대폰,
        인증된휴대폰번호: 회원정보.휴대폰, // 인증 완료할 경우 휴대폰 번호 저장 -> 휴대폰 번호를 수정 할 시 비교하여 다시 인증 진행
        입력인증번호: '',
        발급인증번호: '',
        isPhoneSuccess: false, // 인증창
        phoneSuccessCheck: true, // 인증성공여부
    ...
    React.useEffect(()=>{
        ...
        if(state.비밀번호!=='' && state.비밀번호 === state.비밀번호확인 && state.이름.length>2 && state.phoneSuccessCheck === true && state.이메일!==''){
            isUpdateBtn = true;
        }
        else {
            isUpdateBtn = false;
    ...
    },[state.아이디중복확인, state.비밀번호, state.비밀번호확인, state.이름, state.이메일, state.phoneSuccessCheck])

    const onSubmitadminUpdate=(e)=>{
        e.preventDefault();
        ...
        .then((res)=>{
            if(res.status===200){
                console.log(res.data); 
                if(res.data===1){
                    if(selector.signIn.로그인정보.구분==='일반' || selector.signIn.로그인정보.구분==='관리자') {
                        confirmModalMethod('수정 완료됐습니다. \n 다시 로그인해주세요.');
                        localStorage.removeItem('RANKING_SIGNIN_DATA');
                    }

                }
                else if(res.data===0) { 
                    confirmModalMethod('수정 실패하였습니다.');
                }
            }
    ...
    return (
            <div className="right">
                ...
                <div className="right-content-update">
                    <form onSubmit={onSubmitadminUpdate}>
                        <ul>
                            <li>
                                <div className="gap">
                                    <div className="label-box">
                                        <label htmlFor="adminId">아이디 <i></i></label>
                                    </div>
                            ...
                            <li>
                                ...
                                {
                                        state.guidTextBox && (
                                            <div className="guid-box guid-box1">
                                    ...
                                    <div className="guid-box guid-box3">
                            ...
                            <li>
                                <div className="gap">
                                    <div className="label-box">
                                        <label htmlFor="adminName">이름 <i></i></label>
                                    </div>
                            ...
                            <li>
                                <div className="gap">
                                    <div className="label-box">
                                        <label htmlFor="adminPhone">휴대폰 <i></i></label>
                                    </div>
                                    <div className="input-btn-box phone-box">
                                        <input
                                            type="text"
                                            id='adminPhone'
                                            name='adminPhone'
                                    ...
                                    {   
                                        state.isPhoneSuccess && ( 
                                            <div className="input-btn-box phone phone-box">
                                                <input
                                                    type="text"
                                                    id='adminPhoneAuthen'
                            ...
                            <li>
                                <div className="gap">
                                    <div className="label-box">
                                        <label htmlFor="adminEmail">이메일 <i></i></label>
                                    </div>
                                    <div className="input-btn-box">
                                        <input
                                            type="text"
                                        ...
                                        <div className="select-box" >
                                            <div className="box" >
                                                ...
                                                <button className='drop-btn' href="!#" onClick={(e)=>onClickDropDown(e, false)}>
                                                    <span>
                                                        {state.value}
                                                    </span>
                            ...
                            <li className='btn-box'>
                                <div className="gap">
                                    <input disabled={!state.isUpdateBtn} type="submit" id='updateBtn' name='updateBtn' value={'확인'} className={`${state.isUpdateBtn?'on':''}`} />
                                </div>
                            </li>
                        </ul>
                    </form>
