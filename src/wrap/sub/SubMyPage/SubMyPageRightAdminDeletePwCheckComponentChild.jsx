...
export default function SubMyPageRightAdminDeletePwCheckComponentChild () {
                ...
                <div className="right-content">
                    ...
                    <form action="" onSubmit={onSubmitPwCheck}>
                        <div className="input-box">
                            <input type="password" id='adminId' name='adminId' placeholder='비밀번호 입력' value={state.비밀번호} onChange={onChangePw} />
