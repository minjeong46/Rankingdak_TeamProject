...
export default function SubUserSignInPwResetComponent () {
    ...
    const onSubmitPwReset=(e)=>{
        ...
        axios({
            url: 'https://mj46.co.kr/rankingdak/rankingdak_user_pw_reset.php',
            method: 'POST',
            data: formData,
        })
        .then((res)=>{
            ...
            if(res.status===200){
                if(res.data===1){
                    confirmModalMethod('비밀번호 변경이 완료됐습니다.')

                }
                else {
                    confirmModalMethod('비밀번호 변경이 실패하였습니다. 다시 시도 해주세요')
                }
            }
