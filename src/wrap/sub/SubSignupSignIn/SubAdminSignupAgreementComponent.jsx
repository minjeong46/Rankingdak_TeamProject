...
import '../SubSignupSignIn/scss/SubSignupAgreement.scss'
import { useNavigate } from 'react-router-dom';

export default function SubAdminSignupAgreementComponent () {
    ...
    const onClickList=(e, n)=>{
        ...
        let list = state.checkText;
        console.log(refList.current[0].offsetHeight);

        if(refList.current[n].offsetHeight===0){
            refList.current[n].style.transition = "all 0.3s ease-in-out";
            refList.current[n].style.height = `125px`;
            list[n] = true;
        }
        else {
            refList.current[n].style.transition = "all 0.3s ease-in-out";
            refList.current[n].style.height = 0;
            list[n] = false;
    ...
    const onChangeAgreementAllCheck=(e)=>{
        let 이용약관동의 = [];
    ...
    const onChangeAgreementCheck=(e)=>{
    ...
    React.useEffect(()=>{
        ...
        setState({
            ...state,
            cnt: cnt,
            isOff: cnt===2?false:true,
        })
    },[state.이용약관동의])

    const onClickAgreeBtn=(e)=>{
        e.preventDefault();
    ...
    return (
        <main id='signup-agreement'>
            <section id="section1">
                <div className="container">
                    <div className="title">
                        <h2><em>관리자</em> 이용약관동의</h2>
                            ...
                            <ul>
                                    ...
                                    <div className="gap">
                                        <div className="check">
                                            <input
                                                ...
                                                name='checkFull'
                                                value={'약관 전체동의'}
                                                onChange={onChangeAgreementAllCheck}
                                                checked={state.이용약관동의.length===5}
                                            />
                                            <label htmlFor="checkFull" ><span className='fullcheck'>약관 전체동의</span></label>
                                        </div>
                                        <p>선택 항목에 대한 동의를 거부하는 경우에도 서비스를 이용하실 수 있습니다.</p>
                                    </div>
                                </li>
                                <li>
                                    <div className="gap">
                                        <div className="check">
                                            <input
                                                ...
                                                name='check'
                                                value={'(필수)회원가입 약관동의'}
                                                onChange={onChangeAgreementCheck}
                                                checked={state.이용약관동의.includes('(필수)회원가입 약관동의')}
                                            />
                                            <label htmlFor="check1"><em className='tag tag1'>(필수)</em><span> 회원가입 약관동의</span></label>
                                            <a href="!#" onClick={(e)=>onClickList(e, 0)}><img className={`${state.checkText[0]?'on':''}`}  src="./images/sub/signup/ico-dlv-arrow.png" alt="" /></a>
                                        </div>
                                ...
                                <li>
                                    <div className="gap gap1">
                                        <div ref={(e)=>refList.current[0]=e} className="txt-box">
                                            <div className="padding-box">
                                                <p className='agree1'>
                                                    ...
                                                    ⑩ "상품권 등"이란 "회원"이 "몰"의 "서비스"를 통해 재화 등을 구매 시 판매가격에서 상품권에 표시된 금액만큼을 결제할 수 있는 수단을 의미하며, 일련의 숫자 혹은 로마자로 구성된 코드 등의 형태 또는 "발행사"가 전자금융거래법을 근거로 하여 발행하는 선불전자지급수단으로서, 이전 가능한 금전적 가치가 전자적 방법으로 저장되어 발행된 증표 또는 그 증표에 관한 정보이다.<br />
                                                    ⑪ "발행사"란 "몰"에서 공급하는 대상상품과 교환할 수 있는 권리가 구체화된 바코드 형태의 모바일 교환권인 기프티콘 서비스 업체를 말합니다.<br />
                                                    ...
                                                    ④ 사업종목의 전환, 사업의 포기, 업체간의 통합 등의 이유로 서비스를 제공할 수 없게 되는 경우에는 "몰"은 제8조에 정한 방법으로 이용자에게 통지하고 당초 "몰"에서 제시한 조건에 따라 소비자에게 보상합니다. 다만, "몰"이 보상기준 등을 고지하지 아니한 경우에는 이용자들의 ”마일리지 포인트” 또는 “예치금”&nbsp;"상품권" 등을 "몰"에서 통용되는 통화가치에 상응하는 현물 또는 현금으로 이용자에게 지급합니다.<br />
                                                    <br />
                                                    제6조(회원가입)&nbsp;<br />
                                                    ...
                                                    ④ "몰"은 "상품권 등"의 "서비스"의 경우 "상품권"의 유효기간 및 연장 알림 등 안내 고지의무가 없으며 "회원"은 "발행사"에서 관련 이용약관 의거하여 공지받을 수 있습니다.&nbsp;<br />
                                                    <br />
                                                    제9조(구매신청)<br />
                                                    ...
                                                    <br />
                                                    제15조 (상품권 제도)<br />
                                                    ① "상품권" 사용을 위해서는 "몰"에 회원가입 후 상품권 번호를 등록(조회)해야만 사용(결제)이 가능합니다.&nbsp;<br />
                                                    ② "상품권" 사용은 주문 1회당 횟수 제한 없이 결제하여 사용이 가능합니다.&nbsp;<br />
                                                    ③ "상품권"은 분할 사용이 가능한 잔액 관리형 "상품권"입니다. (다음 주문 시 남은 금액을 사용할 수 있습니다.)<br />
                                                    ④ "상품권" 사용하여 결제 시 현금영수증 발행이 가능합니다.&nbsp;<br />
                                                    ⑤ "상품권" 유효기간의 연장은 "발행사"의 고객센터로 연락하여 신청할 수 있으며, 유효기간 만료 시 기간 연장이 불가합니다.&nbsp;<br />
                                                    ⑥ "상품권" 을 사용한 복합결제의 환불/일부환불할 경우, 동일비율로 계산되어 환불처리됩니다.&nbsp;<br />
                                                    ⑦ "상품권" 사용 시 정기배송, 선물하기, 무통장 결제 서비스 이용 불가합니다.&nbsp;<br />
                                                    ⑧ "상품권" 번호 도난, 분실 등의 "회원" 부주의로 발생한 사고에 대해서는 보상이 불가합니다.&nbsp;<br />
                                                    <br />
                                                    제16조(수신확인통지·구매신청 변경 및 취소)<br />
                                                    ...
                                                    <br />
                                                    제2조. 정기배송 서비스 이용 자격<br />
                                                    정기배송 서비스는 주식회사 (주)푸드나무(이하 “회사”라 한다) 회원이면 누구나 정기배송 서비스를 신청함으로써 이용이 가능합니다.<br />
                                                    <br />
                                                    제3조. 정기배송 서비스 상품의 결제 등<br />
                                                    ① 회사는 정기배송 서비스 상품에 대하여 할인 혜택을 제공할 수 있으며, 할인율 및 거래조건 등은 상품 별로 다를 수 있고 변경될 수 있습니다.&nbsp;<br />
                                                    ② 정기배송 서비스의 특성 상 상품의 가격은 계속적으로 변경될 수 있으며, 고객에게 고지된 시점의 상품 가격을 기준으로 결제가 이루어집니다. 가격 결정의 기준 시점은 변경될 수 있습니다.&nbsp;<br />
                                                    ③ 정기배송 서비스 상품의 추가 또는 변경 시 결제되는 총 상품의 금액은 변경됩니다.<br />
                                                    ④ 정기배송 구매시 적립 포인트 및 증정 상품은 고객 등급의 변동 및 사은품의 변경 등으로 회차별 자동결제 시점에 따라 변동될 수 있습니다.<br />
                                                    ⑤ 카드 한도 초과 등으로 상품의 결제가 이루어 지지 않을 경우, 해당 회차의 정기배송은 이루어지지 않을 수 있으며, 위와 같은 상황이 2회 이상 지속되는 경우 회사는 정기배송 서비스를 중지할 수 있습니다.<br />
                                                    <br />
                                                    제4조. 정기배송 서비스 상품의 판매 종료 등<br />
                                                    정기배송 대상 상품을 더 이상 판매할 수 없거나 해당 상품을 정기배송 서비스로 제공할 수 없는 사유가 있는 경우, 회사는 해당 상품의 정기배송 서비스를 중지하거나 해당 회차의 상품을 공급하지 않을 수 있습니다.<br />
                                                    <br />
                                                    제5조. 정기배송 서비스의 종료<br />
                                                    고객은 회사에게 통지함으로써 정기배송 서비스를 종료시킬 수 있습니다. 단, 배송준비 전상태의 상품에 한해 종료 가능합니다.&nbsp;<br />
                                                    <br />
                                                    제6조. 정기배송 서비스 이용의 제한<br />
                                                    ① 고객의 통지 또는 과실에 의해서 정기배송 서비스가 중지되는 경우(일부 상품에 대하여 정기배송 서비스가 중지되는 경우를 포함합니다.) 해당 상품의 정기배송 서비스 신청이 2개월의 범위 내에서 제한될 수 있습니다.<br />
                                                    ② 회사는 특정상품에 대하여 구매 수량을 제한할 수 있습니다.<br />
                                                    ③ 회사는 상품의 재판매 가능성이 있는 경우, 또는 불법적이거나 부당한 행위와 관련된 경우 정기배송 서비스 제공을 제한할 수 있습니다.<br />
                                                    ④ 서비스 이용의 제한에 대한 구체적인 기준은 내부 운영정책에 따라 적용됩니다.<br />
                                                    ⑤ 회사는 자체적인 시스템을 통한 모니터링과 각종 기관에서 접수된 민원 내용, 수사기관의 정보 등을 통해 정황을 확인한 후, 정기배송 서비스 제한 사유 행위를 한 것으로 추정되는 경우 정기배송 서비스 이용을 제한할 수 있습니다.<br />
                                                    <br />
                                                    제7조. 기타<br />
                                                    ① 고객이 본 약관에 동의함으로써 약관의 효력이 발생하고(현재 계속 중인 정기배송 서비스에도 적용됩니다.), 정기배송 서비스가 계속되는 동안 본 약관의 효력은 유지됩니다. 고객이 정기배송 서비스 이용을 시작하고 정기배송 상품을 추가, 변경하는 경우에도 본 약관이 계속 적용됩니다.<br />
                                                    ② 정기배송 서비스의 개인정보보호정책은 회사 홈페이지의 개인정보취급방침을 준용합니다.<br />
                                                    ③ 본 약관에서 정하지 아니한 내용은 회사 이용약관에 따릅니다.<br />
                                                    ④ 회사가 약관을 변경하는 경우에는 기존약관과 개정약관 및 개정약관의 적용일자와 개정사유를 명시하여 현행약관과 함께 그 적용일자 7일 전부터 적용일 이후 상당한 기간 동안 공지만을 하고, 개정 내용이 고객에게 불리한 경우에는 그 적용일자 30일 전부터 적용일 이후 상당한 기간 동안 이를 회사 홈페이지에 공지하고 고객의 이메일 주소로 약관 개정 사실을 발송하여 고지합니다.<br />
                                                    ⑤ 회사가 전항에 따라 고객에게 통지하면서 공지 또는 공지∙고지일로부터 개정약관 시행일 7일 후까지 거부의사를 표시하지 아니하면 이를 승인한 것으로 본다는 뜻을 명확하게 고지하였음에도 불구하고 거부의 의사표시가 없는 경우에는 변경된 약관을 승인한 것으로 봅니다. 고객이 개정약관에 동의하지 않을 경우 고객은 제5조에 따라 정기배송 서비스를 종료시킬 수 있습니다.<br />
                                                    <br />
                                                    <br />
                                                    <br />
                                                    [부칙]<br />
                                                    제1조(시행일)<br />
                                                    ① 이 약관은 2023년 7월 5일부터 적용됩니다.<br />
                                    ...
                                    <div className="gap">
                                        <div className="check">
                                            <input
                                                ...
                                                onChange={onChangeAgreementCheck}
                                                checked={state.이용약관동의.includes('(필수)개인정보 수집 및 이용 동의')}
                                            />
                                            <label htmlFor="check2"><em className='tag tag1'>(필수)</em><span>개인정보 수집 및 이용 동의</span></label>
                                            <a href="!#" onClick={(e)=>onClickList(e, 1)}><img className={`${state.checkText[1]?'on':''}`} src="./images/sub/signup/ico-dlv-arrow.png" alt="" /></a>
                                        </div>
                                ...
                                <li>
                                    <div className="gap gap1">
                                        <div ref={(e)=>refList.current[1]=e} className="txt-box">
                                            <div className="padding-box">
                                                <table className='agree2'>
                                                    <colgroup>
                                                        <col />
                                                    </colgroup>
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <th>개인정보 수집 항목</th>
                                                            <td>아이디, 비밀번호, 본인확인정보(CI, DI, 생년월일, 성별, 내외국인구분), 휴대폰번호, 이메일</td>
                                                        </tr>
                                                        <tr>
                                                            <th>개인정보 보유 및 이용 기간</th>
                                                            <td>
                                                                통신비밀보호법, 전자상거래 등에서의 소비자보호에 관한 법률 등 관계법령의 규정에 의하여 보존할 필요가 있는 경우 회사는 관계법령에서 정한 일정한 기간 동안 회원정보 를 보관합니다. 이 경우 회사는 보관하는 정보를 그 보관의 목적으로만 이용하며 보존기간은 아래와 같습니다.<br />
                                                                - (전자상거래법) 표시·광고에 관한 기록 : 6개월<br />
                                                                - (전자상거래법) 계약 또는 청약철회, 대금결제, 재화 등의 공급기록 : 5년<br />
                                                                - (전자상거래법) 소비자의 불만 또는 분쟁처리에 관한 기록 : 3년<br />
                                                                - (통신비밀보호법) 로그인 기록(로그기록, 접속지의 추적자료) : 3개월<br />
                                                                <br />
                                                                회원에서 탈퇴한 후 회원 재가입, 임의해지 등을 반복적으로 행하여 회사가 제공하는 할인쿠폰, 이벤트 혜택 등으로 경제상의 이익을 취하거나 이 과정에서 명의를 무단으로 사용하는 편법과 불법행위를 하는 회원을 차단 하고자 회원 탈퇴 후 90일 동안 보관합니다<br />
                                                                - 부정이용기록에 대한 기록 : 1년
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                <strong>※ 이용자(정보주체자)는 개인정보 수집 및 이용 동의를 거부할 권리가 있습니다.
                                                    단, 개인정보 수집 및 이용 동의 거부 시 서비스 이용에 제약이 있을 수 있습니다.</strong>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                    ...
                                    <div className="gap">
                                        <div className="check">
                                            <input
                                                ...
                                                id='check3'
                                                name='check'
                                                value={'(선택)개인정보 수집 및 이용 동의'}
                                                onChange={onChangeAgreementCheck}
                                                checked={state.이용약관동의.includes('(선택)개인정보 수집 및 이용 동의')}
                                            />
                                            <label htmlFor="check3"><em className='tag tag1'>(선택)</em><span>개인정보 수집 및 이용 동의</span></label>
                                            <a href="!#" onClick={(e)=>onClickList(e, 2)}><img className={`${state.checkText[2]?'on':''}`} src="./images/sub/signup/ico-dlv-arrow.png" alt="" /></a>
                                        </div>
                                ...
                                <li>
                                    <div className="gap gap1">
                                        <div ref={(e)=>refList.current[2]=e} className="txt-box">
                                            <div className="padding-box">
                                                <table className='agree2'>
                                                    <colgroup>
                                                        <col />
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <th className='padding-top-zero'>개인정보 수집 항목</th>
                                                            <td className='padding-top-zero'>추천아이디</td>
                                                        </tr>
                                                        <tr>
                                                            <th>개인정보 보유 및 이용 기간</th>
                                                            <td>
                                    ...
                                    <div className="gap">
                                        <div className="check">
                                            <input
                                                ...
                                                value={'(선택)이메일수신동의'}
                                                onChange={onChangeAgreementCheck}
                                                checked={state.이용약관동의.includes('(선택)이메일수신동의')}
                                            />
                                            <label htmlFor="check4"><em className='tag tag1'>(선택)</em><span>이메일수신동의</span><em className='tag tag2'>(상품 및 서비스 안내, 이벤트 정보 및 혜택제공)</em></label>
                                        </div>
                                    </div>
                                </li>
                                <li className='bar'>
                                    <div className="gap">
                                        <div className="check">
                                            <input
                                                ...
                                                id='check5'
                                                name='check'
                                                value={'(선택)SMS(문자,카카오톡) 수신동의'}
                                                onChange={onChangeAgreementCheck}
                                                checked={state.이용약관동의.includes('(선택)SMS(문자,카카오톡) 수신동의')}
                                            />
                                            <label htmlFor="check5"><em className='tag tag1'>(선택)</em><span>SMS(문자,카카오톡) 수신동의</span><em className='tag tag2'>(상품 및 서비스 안내, 이벤트 정보 및 혜택제공)</em></label>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li className='btn-box'>
                                    <div className="gap">
                                        <input onClick={onClickAgreeBtn} type="button" id='checkBtn' name='checkBtn' value={'다음'} disabled={state.isOff} className={`${state.cnt===2?'on':''}`} />
                                    </div>
                                </li>
                            </ul>
                        </form>
