...
export default function SubUserSignInIdSearchComponent () {
    ...
    const onSubmitPhone=(e)=>{
        ...
        axios({
            url:'https://rankingdark.store/rankingdak_user_id_search_phone.php',
            method:'POST',
            data: formData 
        })
        .then((res)=>{
            if(res.status===200){
                if(res.data===0){
                    ...
                    // })
                        ...
                        navigate('/userSigninIdSearchResult', {
                            state : {
                                아이디: res.data.아이디
                            }
                        })
    ...
    const onSubmitEmail=(e)=>{
        ...
        axios({
            url:'https://rankingdark.store/rankingdak_user_id_search_email.php',
            method:'POST',
            data: formData 
        })
        .then((res)=>{
    ...
    return (
        <div id='signin-user-id-search' className='signin-search'>
            <section id="section1">
