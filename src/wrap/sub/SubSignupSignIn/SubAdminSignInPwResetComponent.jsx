...
import '../SubSignupSignIn/scss/SubSigninPwReset.scss'
import { useNavigate, useLocation } from 'react-router-dom';
import axios from 'axios';
import { confirmModal } from '../../../reducer/confirmModal';
import { useDispatch, useSelector } from 'react-redux';

export default function SubAdminSignInPwResetComponent () {
    ...
    const onSubmitPwReset=(e)=>{
        ...
        axios({
            url: 'https://mj46.co.kr/rankingdak/rankingdak_admin_pw_reset.php',
            method: 'POST',
            data: formData,
        })
        .then((res)=>{
            ...
            if(res.status===200){
                if(res.data===1){
                    confirmModalMethod('관리자님, 비밀번호 변경이 완료됐습니다.')
                }
                else {
    ...
    return (
        <main id='signin-pw-reset'>
            <section id="section1">
                <div className="container">
                    <div className="title">
                        <h2><em>관리자</em> 비밀번호 재설정</h2>
                    </div>
