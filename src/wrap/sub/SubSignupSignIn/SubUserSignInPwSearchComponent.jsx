...
export default function SubUserSignInPwSearchComponent () {
    ...
    const onSubmitPhone=(e)=>{
        ...
        axios({
            url:'https://mj46.co.kr/rankingdak/rankingdak_user_pw_search_phone.php',
            method:'POST',
            data: formData 
        })
        .then((res)=>{
    ...
    const onSubmitEmail=(e)=>{
        ...
        axios({
            url:'https://mj46.co.kr/rankingdak/rankingdak_user_pw_search_email.php',
            method:'POST',
            data: formData 
        })
        .then((res)=>{
    ...
    return (
        <div id='signin-user-pw-search' className='signin-search'>
            <section id="section1">
