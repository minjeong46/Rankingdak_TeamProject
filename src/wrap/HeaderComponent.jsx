...
export default  function HeaderComponent(){
    ...
    const onClickLogout=(e)=>{
        ...
        if(selector.signIn.로그인정보.아이디저장===false){
            localStorage.removeItem('RANKING_SIGNIN_DATA');
        }
        else if(selector.signIn.로그인정보.구분==='일반') {
            
            localStorage.removeItem('RANKING_SIGNIN_DATA');
        }
        else if(selector.signIn.로그인정보.구분==='관리자') {
                            ...
                            { 
                                selector.signIn.로그인정보 === null && (
                                        <>
                                            ...
                                            <i>|</i>                            
                                            <Link to="/userSignupAgree">회원가입</Link>
                                            <i>|</i>
                                            <a href="!#">주문조회</a>
                                            <i>|</i>
                               ...
                               { 
                                selector.signIn.로그인정보 !== null && (
                                        <>
                                            <span><em>{selector.signIn.로그인정보.구분}</em> <strong>{selector.signIn.로그인정보.이름} 님</strong></span>
                                            <i>|</i>
                                            <a href="!#" onClick={onClickLogout}>로그아웃</a>
                                            <i>|</i>                            
                                            {
                                                selector.signIn.로그인정보.구분==='일반' && (
                                                    <Link to="/mypageUserUpdatePwCheck">정보수정</Link>
                                                )
                                            }
                                            {
                                                selector.signIn.로그인정보.구분==='관리자' && (
                                                    <Link to="/mypageAdminUpdatePwCheck">정보수정</Link>
                                                )
                                            }
                                            <i>|</i>
                                            <a href="!#">주문조회</a>
                    ...
                    <div className="container">
                        <div className="content">
                            ...
                            <div className="right" onClick={onClickSearchClose}>
                                <span>
                                    <Link to="/Pedometer"><img src="./images/intro/header/top-util-pedometer.png" alt="" /></Link>
                                    <Link to="/coupon"><img src="./images/intro/header/coupon.png" alt="" /></Link>
                                    {
                                        selector.signIn.로그인정보 !== null && (
                                            <>
                                                {
                                                    selector.signIn.로그인정보.구분==='일반' && (
                                                        <Link to="/mypageUserUpdatePwCheck"><img src="./images/intro/header/mypage.png" alt="" /></Link>
                                                    )
                                                }
                                            
                                                {
                                                    selector.signIn.로그인정보.구분==='관리자' && (
                                                        <Link to="/mypageAdminUpdatePwCheck"><img src="./images/intro/header/mypage.png" alt="" /></Link>
                                                    )
                                                }
                                            </>
                                        )
                                    ...
                                    <Link to="/cart">
                                        <img src="./images/intro/header/cart.png" alt="" />
                                        {
                                            selector.cartMethod.cart.length >= 1 && (
                                                <span><i>{selector.cartMethod.cart.length}</i></span>
                                            )
                                        }
                                    </Link>
                                </span>
                    ...
                    <div className="container">
                        <div className="content">
                                ...
                                <div className="category-main" >
                                    <div  className="category">
                                        ...
                                        <ul className="category-list">
                                            <li  ref={CategoryList}>
                                                <a href="!#" onMouseEnter={onMouseEnter1} onMouseLeave={onMouseLeave1}>
                            ...
                            <div className="center">
                                <nav> 
                                    <Link to="/sub1">랭킹</Link>
                                    <Link to="/sub2">이달의 특가</Link>
